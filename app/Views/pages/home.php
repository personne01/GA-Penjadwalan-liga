  ...
  <div>
    <div class="mx-auto d-flex flex-lg-row flex-column hero">
      ...
      <div class="left-column d-flex flex-lg-grow-1 flex-column align-items-lg-start text-lg-start align-items-center text-center">
        <p class="text-caption">Aksi Seluruh Desa di Jombang</p>
        <h1 class="title-text-big">
          Cara Efektif<br class="d-lg-block d-none" />
          Pelayanan Vaksin <Covid-19>Covid-19</Covid-19>
        </h1>
...
<section class="h-100 w-100 bg-white" style="box-sizing: border-box">
  ...
  <div class="content-2-2 container-xxl mx-auto p-0  position-relative" style="font-family: 'Poppins', sans-serif">
    <div class="text-center title-text">
      <h1 class="text-title">Keuntungan Sistem</h1>
      <p class="text-caption" style="margin-left: 3rem; margin-right: 3rem">
        Keuntungan dan kelebihan yang didapat dengan adanya sistem informasi ini
      </p>
    </div>
